...
class Download(TaskManager):
    ...
    def on_add_torrent_alert(self, alert: lt.add_torrent_alert) -> None:
        ...
        # TODO:
        # - Option 1, received our own add_torrent_alert:
        #   o no issue
        # - Option 2, delayed add_torrent_alert from previous metainfo lookup:
        #   o ABSOLUTELY DO NOT USE THIS HANDLE!!!
        #   o We can get the torrent info from this though.
