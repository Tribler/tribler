...
class TriblerConfigManager:
    ...
    @overload
    def set(self, option: Literal["libtorrent/listen_interface_v6"], value: str) -> None: ...
    @overload
    def set(self, option: Literal["libtorrent/port_v6"], value: int) -> None: ...
    @overload
    ...
    @overload
    def set(self, option: Literal["libtorrent/download_defaults/trackers_file_sync_url"], value: str) -> None: ...
    @overload
    ...
    @overload
    def get(self, option: Literal["libtorrent/listen_interface_v6"]) -> str: ...
    @overload
    def get(self, option: Literal["libtorrent/port_v6"]) -> int: ...
    @overload
    ...
    @overload
    def get(self, option: Literal["libtorrent/download_defaults/trackers_file_sync_url"]) -> str: ...
    @overload
