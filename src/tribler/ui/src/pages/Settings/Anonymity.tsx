...
export default function Anonimity() {
    ...
    return (
        <div className="p-6 w-full max-w-[700px]">
            ...
            <p>
                {t("ForMoreInfoRead")}{" "}
                <a href="https://www.tribler.org/anonymity.html" className="font-semibold">
            ...
            <div className="flex items-center py-4">
                <div className="whitespace-pre-line text-xs text-center px-2">{t("MinHops")}</div>
                <Slider
                ...
                />
                <div className="whitespace-pre text-xs text-center px-2">{t("MaxHops")}</div>
            </div>
