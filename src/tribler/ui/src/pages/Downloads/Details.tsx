                    ...
                    <div className="flex flex-col p-4 text-sm">
                        <div className="flex flex-row">
                            ...
                            <div className="basis-3/4 m-auto">
                                <Pieces numpieces={download.total_pieces} pieces64={download.pieces || ""} />
                            </div>
                        </div>
                        <div className="flex flex-row">
                        ...
                        <div className="flex flex-row">
                            ...
                            <div className="basis-3/4">
                                {t("SeedersLeechers", {seeders: download.num_seeds, leechers: download.num_peers})}
                            </div>
                        </div>
                        <div className="flex flex-row">
                                ...
                                {download.completed_dir && download.completed_dir !== download.destination && (
                                    <TooltipProvider>
                                        <Tooltip>
                                            ...
                                            <TooltipContent>
                                                <span>
                                                    {t("MoveAfterCompletionInfo")}{" "}
                                                    <div className="font-semibold">{download.completed_dir}</div>
                                                </span>
                                            </TooltipContent>
                                        </Tooltip>
                                    </TooltipProvider>
                        ...
                        <div className="flex flex-row">
                            ...
                            <div className="basis-3/4">
                                {download.all_time_ratio < 0 ? String(`∞`) : download.all_time_ratio.toFixed(2)}
                                &nbsp;({formatBytes(download.all_time_upload)} /{" "}
