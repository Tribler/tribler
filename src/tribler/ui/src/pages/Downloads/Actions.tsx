...
function getBandwidthLimit(
    ...
    const limits = selectedDownloads.map((download) =>
        direction === "up" ? download.upload_limit : download.download_limit
    );
            ...
            <ContextMenuContent
                ...
                <ContextMenuSub>
                    ...
                    <ContextMenuSubContent className="w-48 bg-neutral-50 dark:bg-neutral-950">
                        <ContextMenuRadioGroup value={String(getBandwidthLimit(selectedDownloads, "down"))}>
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        if (downloadLimitRef.current?.value) {
                                            setBandwidthLimit(
                                                selectedDownloads,
                                                +downloadLimitRef.current?.value * 1024,
                                                "down",
                                                t
                                            );
                                        }
                ...
                <ContextMenuSub>
                    ...
                    <ContextMenuSubContent className="w-48 bg-neutral-50 dark:bg-neutral-950">
                        <ContextMenuRadioGroup value={String(getBandwidthLimit(selectedDownloads, "up"))}>
                            {defaultLimits.map((limit) => (
                                <ContextMenuRadioItem
                                    value={limit.toString()}
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        if (uploadLimitRef.current?.value) {
                                            setBandwidthLimit(
                                                selectedDownloads,
                                                +uploadLimitRef.current?.value * 1024,
                                                "up",
                                                t
                                            );
                                        }
