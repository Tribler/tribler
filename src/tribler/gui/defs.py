...
TRUST_GRAPH_PEER_LEGENDS = (
        "<span style='color:{}'>\u25CF Helpful user </span> &nbsp;&nbsp;&nbsp;"
        "<span style='color:{}'>\u25CF Selfish user </span> &nbsp;&nbsp;&nbsp;"
        "<span style='color:{}'>\u25CF Unknown </span> &nbsp;&nbsp;&nbsp;"
        "<span style='color:{}'>\u25CF Selected</span>".format(COLOR_GREEN, COLOR_RED, COLOR_NEUTRAL, COLOR_SELECTED)
)
