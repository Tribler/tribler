...
from tribler.core.knowledge.content_bundling import calculate_diversity, group_content_by_number
...
class SearchResultsModel(ChannelContentModel):
    ...
    def create_bundles(self, content_list: list[dict], filter_zero_seeders=True, min_bundle_size=3) -> list[dict]:
        ...
        :param filter_zero_seeders: if True, items with zero seeders are filtered out
        :param min_bundle_size: minimum number of items in a bundle
        :returns: list of content items and bundles
        """
    ...
    def add_items(self, new_items: list[dict], on_top=False, remote=False) -> None:
        """
