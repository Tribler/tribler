...
class TestDownloadsEndpoint(TestBase):
    ...
    def create_mock_download(self) -> Download:
        ...
        return Download(TorrentDefNoMetainfo(b"\x01" * 20, b"test"), config, hidden=False, checkpoint_disabled=True)
    ...
    async def test_get_downloads_hidden_download(self) -> None:
        ...
        """
        self.set_loaded_downloads([Download(TorrentDefNoMetainfo(b"\x01" * 20, b"test"), Mock(),
