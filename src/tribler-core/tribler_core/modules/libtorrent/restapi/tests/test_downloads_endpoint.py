...
async def test_get_downloads_no_downloads(mock_dlmgr, session):
    """
...
async def test_get_downloads(mock_dlmgr, test_download, session):
    """
...
async def test_start_download_no_uri(session):
    """
...
async def test_start_download_bad_params(session):
    """
...
async def test_start_download_from_file(test_download, mock_dlmgr, session):
    """
...
async def test_start_download_with_selected_files(test_download, mock_dlmgr, session):
    """
...
async def test_get_peers_illegal_fields_ascii(test_download, mock_dlmgr, mock_lt_status, session):
    """
...
async def test_get_peers_illegal_fields_unknown(test_download, mock_dlmgr, mock_lt_status, session):
    """
    Testing whether illegal fields are stripped from the Libtorrent download info response.
    """
    mock_dlmgr.get_downloads = lambda: [test_download]
...
async def test_start_invalid_download(mock_dlmgr, session):
    """
...
async def test_remove_no_remove_data_param(session):
    """
...
async def test_remove_wrong_infohash(mock_dlmgr, session):
    """
...
async def test_remove(mock_dlmgr, test_download, session):
    """
...
async def test_stop_download_wrong_infohash(mock_dlmgr, session):
    """
...
async def test_stop_download(mock_dlmgr, test_download, session):
    """
...
async def test_select_download_file_range(mock_dlmgr, test_download, session):
    """
...
async def test_select_download_file(mock_dlmgr, test_download, session):
    """
...
async def test_load_checkpoint_wrong_infohash(mock_dlmgr, session):
    """
...
async def test_resume_download(mock_dlmgr, test_download, session):
    """
...
async def test_recheck_download(mock_dlmgr, test_download, session):
    """
...
async def test_download_unknown_state(mock_dlmgr, test_download, session):
    """
...
async def test_change_hops_error(mock_dlmgr, test_download, session):
    """
...
async def test_export_unknown_download(mock_dlmgr, session):
    """
...
async def test_export_download(mock_dlmgr, mock_handle, test_download, session):
    """
...
async def test_get_files_unknown_download(mock_dlmgr, session):
    """
...
async def test_get_download_files(mock_dlmgr, test_download, session):
    """
...
async def test_stream_unknown_download(mock_dlmgr, session):
    """
...
async def test_stream_download_out_of_bounds_file(mock_dlmgr, mock_handle, test_download, session):
    """
...
async def test_change_hops(mock_dlmgr, test_download, session):
    """
...
async def test_change_hops_fail(mock_dlmgr, test_download, session):
    """
