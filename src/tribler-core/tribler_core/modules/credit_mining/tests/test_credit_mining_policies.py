...
from tribler_common.simpledefs import DLSTATUS_DOWNLOADING, DLSTATUS_SEEDING, DLSTATUS_STOPPED, UPLOAD

from tribler_core.modules.credit_mining.credit_mining_manager import CreditMiningTorrent
from tribler_core.modules.credit_mining.credit_mining_policy import (
    InvestmentPolicy,
    InvestmentState,
    MB,
    RandomPolicy,
