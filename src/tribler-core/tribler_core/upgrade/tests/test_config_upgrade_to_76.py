...
def test_convert_tribler_conf_76(tmpdir):
    ...
    assert config.get_api_key() == '7671750ba34423c97dc3c6763041e4cb'
    assert config.get_api_http_port() == 8085
    assert config.get_api_http_enabled()
    assert not config.get_api_https_enabled()
