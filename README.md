...
### Debian/Ubuntu/Mint
sudo apt-get install python-apsw python-crypto python-gmpy python-libtorrent python-m2crypto python-netifaces python-pyasn1 python-requests python-twisted python-wxgtk2.8 vlc
