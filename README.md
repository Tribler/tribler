...
### Debian/Ubuntu/Mint
sudo apt-get install scons build-essential libevent-dev python-libtorrent python-twisted python-apsw python-wxgtk2.8 python-netifaces python-m2crypto vlc python-pyasn1 python-gmpy libssl-dev
