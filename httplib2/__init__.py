...
try:
    ...
    print >>sys.stderr, 'Unable to import SocksiPy, socks proxy support disabled.'
...
class HTTPConnectionWithTimeout(httplib.HTTPConnection):
    ...
    def __init__(self, host, port=None, strict=None, timeout=None, proxy_type=None, proxy_host=None, proxy_port=None, proxy_rdns=None, proxy_user=None, proxy_pass=None):
    ...
    def connect(self):
        ...
        for res in socket.getaddrinfo(self.host, self.port, 0,
            ...
            try:
                if socks and self.proxy_type and self.proxy_host and self.proxy_port:
                    self.sock = socks.socksocket(af, socktype, proto)
                    self.sock.setproxy(self.proxy_type, self.proxy_host, self.proxy_port, self.proxy_rdns, self.proxy_user, self.proxy_pass)
                else:
...
class HTTPSConnectionWithTimeout(httplib.HTTPSConnection):
    ...
    def __init__(self, host, port=None, key_file=None, cert_file=None,
                 strict=None, timeout=None, proxy_type=None, proxy_host=None, proxy_port=None, proxy_rdns=None, proxy_user=None, proxy_pass=None):
        self.timeout = timeout
        self.proxy_type, self.proxy_host, self.proxy_port, self.proxy_rdns, self.proxy_user, self.proxy_pass = proxy_type, proxy_host, proxy_port, proxy_rdns, proxy_user, proxy_pass
    ...
    def connect(self):
        ...
        if socks and self.proxy_host and self.proxy_port:
            sock = socks.socksocket(socket.AF_INET, socket.SOCK_STREAM)
            sock.setproxy(self.proxy_type, self.proxy_host, self.proxy_port, self.proxy_rdns, self.proxy_user, self.proxy_pass)
        else:
...
class Http:
    ...
    """
    def __init__(self, cache=None, timeout=None, proxy_type=None, proxy_host=None, proxy_port=None, proxy_rdns=None, proxy_user=None, proxy_pass=None):
        self.proxy_type, self.proxy_host, self.proxy_port, self.proxy_rdns, self.proxy_user, self.proxy_pass = proxy_type, proxy_host, proxy_port, proxy_rdns, proxy_user, proxy_pass
            ...
            if conn_key in self.connections:
                ...
                if scheme == 'https' and certs: 
                    conn = self.connections[conn_key] = connection_type(authority, key_file=certs[0][0], cert_file=certs[0][1], timeout=self.timeout, \
                        proxy_type=self.proxy_type, proxy_host=self.proxy_host, proxy_port=self.proxy_port, \
                        proxy_rdns=self.proxy_rdns, proxy_user=self.proxy_user, proxy_pass=self.proxy_pass)
                else:
