...
class StartDownloadDialog(DialogContainer):
    ...
    def __init__(self, parent, download_uri):
        ...
        self.dialog_widget.safe_seed_checkbox.setChecked(self.window().tribler_settings['downloadconfig']['safeseeding_enabled'])
        self.dialog_widget.safe_seed_checkbox.setChecked(self.window().tribler_settings['downloadconfig']['anonymity_enabled'])
