...
class profileOverview(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.perf_Overall = bgPanel(self.bgPanel_Overall, -1, wx.Point(15,15), wx.Size(45,55))
        ...
        self.icon_Overall = bgPanel(self.bgPanel_Overall, -1, wx.Point(351,15), wx.Size(55,55))
        self.bgPanel_Quality = wx.Panel(self,-1,wx.Point(0,299),wx.Size(623,40))
        self.bgPanel_Quality.SetBackgroundColour(wx.Colour(203,203,203))
        self.perf_Quality = bgPanel(self.bgPanel_Quality, -1, wx.Point(15,5), wx.Size(25,30))
        ...
        self.perf_Files = bgPanel(self.bgPanel_Files, -1, wx.Point(15,5), wx.Size(25,30))
        ...
        self.perf_Persons = bgPanel(self.bgPanel_Persons, -1, wx.Point(15,5), wx.Size(25,30))
        ...
        self.perf_Download = bgPanel(self.bgPanel_Download, -1, wx.Point(15,5), wx.Size(25,30))
        ...
        self.perf_Presence = bgPanel(self.bgPanel_Presence, -1, wx.Point(15,5), wx.Size(25,30))
        ...
        self.sz3s.Add([617,0],1,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,3)
        ...
        self.sz243s.Add(self.icon_Overall,0,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.FIXED_MINSIZE,15)
