...
class profileOverview(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.pn248c = wx.Panel(self,-1,wx.Point(0,299),wx.Size(623,40))
        self.pn248c.SetBackgroundColour(wx.Colour(203,203,203))
        self.perfM2 = bgPanel(self.pn248c, -1, wx.Point(15,5), wx.Size(25,30))
        self.st241cC = wx.StaticText(self.pn248c,-1,"",wx.Point(48,18),wx.Size(239,16),wx.ST_NO_AUTORESIZE)
        ...
        self.sz3s.Add([617,55],1,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,3)
        ...
        self.qualityC.Add([15,38],0,wx.EXPAND|wx.FIXED_MINSIZE,3)
        self.qualityC.Add(self.perfM2,0,wx.TOP|wx.BOTTOM|wx.RIGHT|wx.FIXED_MINSIZE,5)
