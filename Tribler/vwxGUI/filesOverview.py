...
class filesOverview(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.tx220c = wx.TextCtrl(self.pn214c,-1,"",wx.Point(453,3),wx.Size(130,22))
        self.tx220c.Show(False)
        self.tx220c.SetLabel("search a file")
        self.tx220c.SetFont(wx.Font(10,74,90,90,0,"Verdana"))
        self.chc215c = wx.Choice(self.pn214c,-1,wx.Point(116,3),wx.Size(120,21),[r'most popular',r'top rated',r'recommended',r'from network'])
        self.chc215c.SetFont(wx.Font(10,74,90,90,0,"Verdana"))
        self.chc215cCC = wx.Choice(self.pn214c,-1,wx.Point(222,3),wx.Size(120,21),[r'today',r'this week',r'this month',r'all time'])
        self.chc215cCC.SetFont(wx.Font(10,74,90,90,0,"Verdana"))
        self.chc215cC = wx.Choice(self.pn214c,-1,wx.Point(10,3),wx.Size(120,21),[r'video',r'audio',r'pictures',r'other',r'xxx'])
        self.chc215cC.SetFont(wx.Font(10,74,90,90,0,"Verdana"))
        self.filesTabs = filesTabs(self,-1,wxDefaultPosition,wxDefaultSize)
        self.filesTabs.SetDimensions(0,56,20,20)
        self.filesTabs.Show(False)
        self.filesGrid = filesGrid(self,-1,wxDefaultPosition,wxDefaultSize)
        self.filesGrid.SetDimensions(10,56,623,429)
        ...
        self.pagerBottomRight = bgPanel(self, -1, wx.Point(440,400), wx.Size(271,28))
        ...
        self.searchIcon = tribler_topButton(self.pn214c, -1, wx.Point(589,3), wx.Size(22,22))
        ...
        self.sz3s.Add(self.filesGrid,1,wx.LEFT|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,10)
        ...
        self.sz216s.Add([8,33],0,wx.EXPAND|wx.FIXED_MINSIZE,3)
        self.sz216s.Add(self.sz221s,1,wx.EXPAND|wx.FIXED_MINSIZE,3)
        self.sz216s.Add(self.tx220c,0,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.ALIGN_RIGHT|wx.FIXED_MINSIZE,3)
        self.sz216s.Add(self.searchIcon,0,wx.TOP|wx.LEFT|wx.BOTTOM|wx.FIXED_MINSIZE,3)
        self.sz216s.Add([10,33],0,wx.EXPAND|wx.FIXED_MINSIZE,3)
