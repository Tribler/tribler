...
class personsDetails(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.st209cCCC = wx.StaticText(self.detailsC,-1,"",wx.Point(8,7),wx.Size(79,18),wx.ST_NO_AUTORESIZE)
        self.st209cCCC.SetLabel("similar taste:")
        self.recommendationField = wx.StaticText(self.detailsC,-1,"",wx.Point(107,7),wx.Size(71,18),wx.ST_NO_AUTORESIZE)
        ...
        self.st209cCC = wx.StaticText(self.detailsC,-1,"",wx.Point(8,28),wx.Size(79,18),wx.ST_NO_AUTORESIZE)
        self.st209cCC.SetLabel("status:")
        self.statusField = wx.StaticText(self.detailsC,-1,"",wx.Point(87,28),wx.Size(131,18),wx.ST_NO_AUTORESIZE)
        ...
        self.vert_sz238s.Add(self.statusSizer,0,wx.LEFT|wx.EXPAND|wx.FIXED_MINSIZE,5)
        self.recommendationSizer.Add(self.st209cCCC,0,wx.FIXED_MINSIZE,3)
        ...
        self.downloadSizer.Add([17,55],1,wx.EXPAND|wx.FIXED_MINSIZE,3)
        ...
        self.statusSizer.Add(self.st209cCC,0,wx.EXPAND|wx.FIXED_MINSIZE,6)
        self.statusSizer.Add(self.statusField,0,wx.EXPAND|wx.FIXED_MINSIZE,10)
