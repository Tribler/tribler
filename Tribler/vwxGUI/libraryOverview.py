...
class libraryOverview(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.pn10cCImg0=self.fileImgBuf[0];
        self.Show(True)
        self.SetBackgroundColour(wx.Colour(255,255,255))
        self.orange_top_left = bgPanel(self, -1, wx.Point(0,0), wx.Size(10,21))
        self.pn10cC = wx.Panel(self,-1,wx.Point(13,405),wx.Size(20,21))
        self.pn10cC.SetForegroundColour(wx.Colour(255,255,255))
        self.pn10cC.SetBackgroundColour(wx.Colour(255,51,0))
        self.pn10cC.Bind(wx.EVT_ERASE_BACKGROUND,self.VwXpn10cC_VwXEvOnEraseBackground)
        self.st64cC = wx.StaticText(self.pn10cC,-1,"",wx.Point(0,4),wx.Size(269,15),wx.ST_NO_AUTORESIZE)
        self.st64cC.SetLabel("Library")
        self.st64cC.SetForegroundColour(wx.Colour(255,255,255))
        self.st64cC.SetBackgroundColour(wx.Colour(255,51,0))
        self.orange_top_right = bgPanel(self, -1, wx.Point(613,0), wx.Size(10,21))
        self.pn214c = wx.Panel(self,-1,wx.Point(3,405),wx.Size(623,35))
        self.pn214c.SetBackgroundColour(wx.Colour(153,153,153))
        self.chc215cC = wx.Choice(self.pn214c,-1,wx.Point(11,3),wx.Size(120,21),[r'video',r'audio',r'pictures',r'other',r'xxx'])
        ...
        self.pagerBottomRight = bgPanel(self, -1, wx.Point(600,402), wx.Size(271,28))
        ...
        self.libraryGrid.SetDimensions(10,66,20,20)
        ...
        self.sz3s.Add(self.libraryGrid,1,wx.TOP|wx.LEFT|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,10)
        self.sz3s.Add(self.footer,0,wx.EXPAND|wx.FIXED_MINSIZE,3)
        self.header.Add(self.orange_top_left,0,wx.FIXED_MINSIZE,3)
        self.header.Add(self.pn10cC,1,wx.EXPAND|wx.FIXED_MINSIZE,3)
        ...
        self.size_title.Add(self.st64cC,0,wx.TOP|wx.EXPAND|wx.FIXED_MINSIZE,4)
        ...
        self.pn10cC.SetSizer(self.size_title);self.pn10cC.SetAutoLayout(1);self.pn10cC.Layout();
