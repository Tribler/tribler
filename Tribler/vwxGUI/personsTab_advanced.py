...
class personsTab_advanced(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.st209c = wx.StaticText(self,-1,"",wx.Point(28,95),wx.Size(150,18),wx.ST_NO_AUTORESIZE)
        ...
        self.addAsFriend = tribler_topButton(self, -1, wx.Point(240,3), wx.Size(55,55))
        ...
        self.downloadSizer.Add(self.addAsFriend,0,wx.LEFT|wx.FIXED_MINSIZE,3)
