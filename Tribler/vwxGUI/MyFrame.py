...
class MyFrame(wx.Frame):
    ...
    def VwXinit(self):
        ...
        self.bt257cC = wx.Button(self.topBG3,-1,"",wx.Point(82,35),wx.Size(55,20))
        self.bt257cC.SetLabel("files")
        self.bt258cC = wx.Button(self.topBG3,-1,"",wx.Point(138,35),wx.Size(55,20))
        ...
        self.horizontal2C.Add(self.bt258cC,0,wx.LEFT|wx.FIXED_MINSIZE,4)
