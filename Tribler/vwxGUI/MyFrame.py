...
class MyFrame(wx.Frame):
    ...
    def VwXinit(self):
        ...
        self.topbg2 = bgPanel(self.level0, -1, wx.Point(341,0), wx.Size(20,20))
        self.topbg2.Bind(wx.EVT_ERASE_BACKGROUND,self.VwXtopbg2_VwXEvOnEraseBackground)
        self.topbg3 = bgPanel(self.level0, -1, wx.Point(506,0), wx.Size(269,89))
        self.topbg3.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_SCROLLBAR))
        self.topbg3.Bind(wx.EVT_ERASE_BACKGROUND,self.VwXtopbg3_VwXEvOnEraseBackground)
        self.st176cCC = wx.StaticText(self.topbg3,-1,"",wx.Point(92,6),wx.Size(49,13),wx.ST_NO_AUTORESIZE)
        self.st176cCC.SetLabel("downloading:")
        self.st176cCC.SetForegroundColour(wx.Colour(255,255,255))
        self.st177cCC = wx.StaticText(self.topbg3,-1,"",wx.Point(92,26),wx.Size(49,13),wx.ST_NO_AUTORESIZE)
        self.st177cCC.SetLabel("uploading:")
        self.st177cCC.SetForegroundColour(wx.Colour(255,255,255))
        self.st178cCC = wx.StaticText(self.topbg3,-1,"",wx.Point(92,40),wx.Size(49,13),wx.ST_NO_AUTORESIZE)
        self.st178cCC.SetLabel("discovered content:")
        self.st178cCC.SetForegroundColour(wx.Colour(255,255,255))
        self.st179cCC = wx.StaticText(self.topbg3,-1,"",wx.Point(92,54),wx.Size(49,13),wx.ST_NO_AUTORESIZE)
        ...
        self.backButton = tribler_topButton(self.topbg1, -1, wx.Point(0,60), wx.Size(25,29))
        self.standardOverview = standardOverview(self.level0,-1,wxDefaultPosition,wxDefaultSize)
        self.standardOverview.SetDimensions(9,98,515,540)
        self.standardDetails = standardDetails(self.level0,-1,wxDefaultPosition,wxDefaultSize)
        self.standardDetails.SetDimensions(699,98,300,462)
        ...
        self.sizerTopMenu.Add(self.topbg3,0,wx.EXPAND|wx.ALIGN_LEFT|wx.ALIGN_TOP|wx.FIXED_MINSIZE,3)
        self.sz11sCCCCCC.Add(self.standardOverview,1,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,9)
        self.sz11sCCCCCC.Add(self.sz135s,0,wx.LEFT|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,9)
        self.sz135s.Add(self.standardDetails,0,wx.TOP|wx.EXPAND|wx.FIXED_MINSIZE,9)
        ...
        self.sz180sC.Add(self.sz175sCC,1,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,3)
