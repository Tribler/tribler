...
class MyFrame(wx.Frame):
    ...
    def VwXinit(self):
        ...
        self.topBG2_grey = bgPanel(self.level0, -1, wx.Point(614,0), wx.Size(192,89))
        self.topBG2_grey.Bind(wx.EVT_ERASE_BACKGROUND,self.VwXtopBG2_grey_VwXEvOnEraseBackground)
        self.topBG3 = bgPanel(self.level0, -1, wx.Point(1191,0), wx.Size(287,89))
        ...
        self.tx220cCCC = wx.TextCtrl(self.topBG3,-1,"",wx.Point(96,9),wx.Size(151,22))
        self.tx220cCCC.SetLabel('search a file')
        self.tx220cCCC.SetFont(wx.Font(10,74,90,90,0,"Verdana"))
        self.bt257cC = wx.Button(self.topBG3,-1,"",wx.Point(96,37),wx.Size(55,20))
        self.bt257cC.SetLabel("files")
        self.bt258cC = wx.Button(self.topBG3,-1,"",wx.Point(159,37),wx.Size(55,20))
        ...
        self.horziontal1 = wx.BoxSizer(wx.HORIZONTAL)
        self.horizontal2 = wx.BoxSizer(wx.HORIZONTAL)
        self.verticalC = wx.BoxSizer(wx.VERTICAL)
        ...
        self.horziontal1.Add([0,60],1,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,3)
        ...
        self.horizontalC.Add(self.tx220cCCC,0,wx.LEFT|wx.ALIGN_LEFT|wx.FIXED_MINSIZE,8)
        self.horizontal2C.Add(self.bt257cC,0,wx.LEFT|wx.EXPAND|wx.ALIGN_LEFT|wx.FIXED_MINSIZE,8)
        self.horizontal2C.Add(self.bt258cC,0,wx.LEFT|wx.EXPAND|wx.ALIGN_LEFT|wx.FIXED_MINSIZE,5)
        ...
        self.vertical1.SetDimension(0,0,10,10);self.vertical1.Layout();
        self.Refresh()
