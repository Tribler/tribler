...
class personsItem(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.statictekst = wx.StaticText(self,-1,"",wx.Point(0,154),wx.Size(117,13),wx.ST_NO_AUTORESIZE)
        self.statictekst.SetLabel("> download")
        self.statictekst.SetForegroundColour(wx.Colour(255,85,0))
        self.statictekst.SetBackgroundColour(wx.Colour(50,153,204))
        ...
        self.sz3s.Add(self.statictekst,0,wx.TOP|wx.EXPAND|wx.FIXED_MINSIZE,3)
