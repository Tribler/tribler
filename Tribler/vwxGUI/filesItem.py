...
class personsItem(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.title = wx.StaticText(self,-1,"",wx.Point(0,73),wx.Size(117,38),wx.ST_NO_AUTORESIZE)
        self.title.SetLabel("NOS 8 Uur Journaal van 24 jan. 2007 and some other characters")
        self.title.SetFont(wx.Font(8,74,90,90,0,"Verdana"))
        ...
        self.sz3s.Add(self.title,0,wx.TOP|wx.EXPAND|wx.FIXED_MINSIZE,3)
