...
#[win]add your code here
    ...
    def pn9c_VwXEvOnEraseBackground(self,event): #init function
        #[732]Code event VwX...Don't modify[732]#
        #add your code here
        event.Skip()
    ...
    def pn12c_VwXEvOnEraseBackground(self,event): #init function
        #[735]Code event VwX...Don't modify[735]#
        #add your code here
        event.Skip()
    ...
    def pn11c_VwXEvOnEraseBackground(self,event): #init function
        #[734]Code event VwX...Don't modify[734]#
        #add your code here
        event.Skip()
    ...
    def pn10c_VwXEvOnEraseBackground(self,event): #init function
        #[733]Code event VwX...Don't modify[733]#
        #add your code here
        event.Skip()
