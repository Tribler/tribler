...
class statusDownloads(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.st32c = wx.StaticText(self,-1,"",wx.Point(3,24),wx.Size(292,133),wx.ST_NO_AUTORESIZE)
        ...
        self.sz23s.Add(self.st32c,0,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,3)
