...
class libraryItem(wx.Panel):
    ...
    def VwXinit(self):
        ...
        self.st5c = wx.StaticText(self,-1,"",wx.Point(3,3),wx.Size(162,14),wx.ST_NO_AUTORESIZE)
        ...
        self.archive = wx.StaticText(self,-1,"",wx.Point(274,3),wx.Size(77,15),wx.ST_NO_AUTORESIZE)
        self.archive.SetLabel("archive")
        self.archive.SetForegroundColour(wx.Colour(128,128,128))
        ...
        self.play = wx.StaticText(self,-1,"",wx.Point(417,10),wx.Size(72,13),wx.SIMPLE_BORDER|wx.ST_NO_AUTORESIZE)
        self.play.SetLabel("> play")
        self.play.SetForegroundColour(wx.Colour(255,85,0))
        self.pb = wx.Gauge(self,-1,100,wx.Point(362,6),wx.Size(39,12),wx.GA_HORIZONTAL)
        ...
        self.vLine = wx.StaticLine(self,-1,wx.Point(362,37),wx.Size(2,2),wx.LI_VERTICAL)
        ...
        self.sz3s.Add(self.play,0,wx.ALIGN_CENTER_VERTICAL|wx.FIXED_MINSIZE,3)
        ...
        self.sz22s.Add(self.vLine,0,wx.TOP|wx.LEFT|wx.BOTTOM|wx.RIGHT|wx.EXPAND|wx.FIXED_MINSIZE,3)
        self.sz16s.Add(self.ck17c,0,wx.TOP|wx.EXPAND|wx.FIXED_MINSIZE,3)
        self.sz16s.Add(self.archive,0,wx.TOP|wx.LEFT|wx.EXPAND|wx.FIXED_MINSIZE,3)
