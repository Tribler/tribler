...
from Tribler.Core.simpledefs import (NTFY_DELETE, NTFY_INSERT, NTFY_UPDATE, STATEDIR_DLPSTATE_DIR,
                                     STATEDIR_WALLET_DIR, STATE_START_API, STATE_UPGRADING_READABLE,
                                     STATE_LOAD_CHECKPOINTS, STATE_READABLE_STARTED, NTFY_TRIBLER, STATE_SHUTDOWN,
                                     STATEDIR_CHANNELS_DIR, STATEDIR_DB_DIR)
