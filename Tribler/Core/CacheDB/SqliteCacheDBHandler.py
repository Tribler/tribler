...
#        self._db.insert(self.table_name, entry=key, value=value)
        ...
        self._db.execute(sql_insert_friendstatistics)
        
    def updateFriendshipStatistics(self, my_permid, target_permid, current_time, isForwarder = 0, no_of_attempts = 0, no_of_helpers = 0):
