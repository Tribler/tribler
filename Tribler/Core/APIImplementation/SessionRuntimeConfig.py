...
class SessionRuntimeConfig(triblerAPI.SessionConfigInterface):
    ...
    def set_tracker_scrape_allowed(self,value):
        raise triblerAPI.triblerAPI.OperationNotPossibleAtRuntimeException()
    ...
    def get_overlay_max_message_length(self):
        self.sesslock.acquire()
        try:
            return triblerAPI.SessionConfigInterface.get_overlay_max_message_length(self)
        finally:
            self.sesslock.release()
    ...
    def get_download_help_dir(self):
        self.sesslock.acquire()
        try:
            return triblerAPI.SessionConfigInterface.get_download_help_dir(self)
        finally:
            self.sesslock.release()
    ...
    def get_bartercast(self):
        self.sesslock.acquire()
        try:
            return triblerAPI.SessionConfigInterface.get_bartercast(self)
        finally:
            self.sesslock.release()
    ...
    def get_superpeer_file(self):
        self.sesslock.acquire()
        try:
            return triblerAPI.SessionConfigInterface.get_superpeer_file(self)
        finally:
            self.sesslock.release()
    ...
    def get_buddycast_collecting_solution(self):
        self.sesslock.acquire()
        try:
            return triblerAPI.SessionConfigInterface.get_buddycast_collecting_solution(self)
        finally:
            self.sesslock.release()
    ...
    def get_peer_icon_path(self):
        self.sesslock.acquire()
        try:
            return triblerAPI.SessionConfigInterface.get_peer_icon_path(self)
        finally:
            self.sesslock.release()
