...
sessdefaults['rss_reload_frequency'] = 2*60*60      # reload a rss source every n seconds
sessdefaults['rss_check_frequency'] = 1        # test a potential .torrent in a rss source every n seconds
