...
def is_audio(s):
    return s[s.rfind('.') + 1:] in AUDIO_EXTENSIONS
...
class XXXFilter(object):
    ...
    def __init__(self, install_dir):
        ...
        self.xxx_terms, self.xxx_searchterms = self._init_terms(termfilename)

    def _init_terms(self, filename):
        terms = set()
        searchterms = set()
