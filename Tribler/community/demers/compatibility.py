...
from Tribler.dispersy.message import DropPacket, Message
from Tribler.dispersy.payload import Payload
from Tribler.dispersy.resolution import PublicResolution

"""Backward compatibility for Demers.

    Usage:
        1. Create DemersCompatibility(newcommunity)
        2. Register compatibility.deprecated_meta_messages()
        3. Register DemersConversion
...
class DemersConversion(BaseConversion):
