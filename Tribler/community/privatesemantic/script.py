...
class SemanticScript(ScenarioScriptBase):
    ...
    def join_community(self, my_member):
        ...
        if self.community_type == 'search':
            community = HForwardCommunity.join_community(self._dispersy, master, self.my_member, self.my_member, integrate_with_tribler=False, forward_to=0, **self.community_kargs)
        elif self.community_type == 'hsearch':
            community = HForwardCommunity.join_community(self._dispersy, master, self.my_member, self.my_member, integrate_with_tribler=False, **self.community_kargs)
        elif self.community_type == 'polisearch':
            community = PoliForwardCommunity.join_community(self._dispersy, master, self.my_member, self.my_member, integrate_with_tribler=False, **self.community_kargs)
        else:
            community = PForwardCommunity.join_community(self._dispersy, master, self.my_member, self.my_member, integrate_with_tribler=False, **self.community_kargs)
