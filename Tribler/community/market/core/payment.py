...
class Payment(Message):
    ...
    def from_database(cls, data):
        ...
        """
        (trader_id, transaction_trader_id, transaction_number, payment_id, transferred_amount,
         transferred_id, address_from, address_to, timestamp, success) = data
    ...
    def to_database(self):
        ...
        :rtype: tuple
        """
        return (six.text_type(self.trader_id), six.text_type(self.transaction_id.trader_id),
                int(self.transaction_id.transaction_number), six.text_type(self.payment_id), self.transferred_assets.amount,
                six.text_type(self.transferred_assets.asset_id), six.text_type(self.address_from),
                six.text_type(self.address_to), float(self.timestamp), self.success)
