...
class ScenarioScriptBase(ScriptBase):
    def __init__(self, *args, **kargs):
        super(ScenarioScriptBase, self).__init__(*args, **kargs)
    ...
    def _run_scenario(self):
        for deadline, call, args in self.parse_scenario():
            while True:
    ...
    def parse_scenario(self):
        ...
        if __debug__:
            for deadline, func, args in scenario:
    ...
    def scenario_start(self):
        ...
        self._master_member = Member.get_instance(self.master_member_public_key)
        self._community = self.community_class.join_community(self._master_member, my_member)
    ...
    def _poisson_churn(self):
        while True:
            ...
            if self._community is None:
                ...
                self._community = self.community_class.load_community(self._master_member)
            else:
...
class ScenarioScript(ScenarioScriptBase):
    @property
    def master_member_public_key(self):
        return "".decode("HEX")
    ...
    # def scenario_end(self):
    #     EffortCommunity.scenario_end()
    #     return super(ScenarioScript, self).scenario_end()
