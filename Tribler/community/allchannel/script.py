...
class AllChannelScenarioScript(ScenarioScriptBase):
    ...
    def join_community(self, dispersy, my_member):
        ...
        return AllChannelCommunity.join_community(dispersy, master, self.my_member, self.my_member, integrate_with_tribler = False)
