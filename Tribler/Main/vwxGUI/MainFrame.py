...
class MainFrame(wx.Frame):
    ...
    def __init__(self, parent, channelonly, internalvideo, progress):
        ...
        if not channelonly:
            ...
            self.librarydetailspanel = wx.Panel(self.splitter_bottom_window)#LibraryDetails(self.splitter_bottom_window)
            self.librarydetailspanel.Show(False)
            self.channeldetailspanel = wx.Panel(self.splitter_bottom_window)#ChannelDetails(self.splitter_bottom_window)
            self.channeldetailspanel.Show(False)
            self.playlistdetailspanel = wx.Panel(self.splitter_bottom_window)#PlaylistDetails(self.splitter_bottom_window)
            self.playlistdetailspanel.Show(False)
            self.searchinfopanel = wx.Panel(self.splitter_bottom_window)#SearchInfoPanel(self.splitter_bottom_window)
            self.searchinfopanel.Show(False)
            self.channelinfopanel = wx.Panel(self.splitter_bottom_window)#ChannelInfoPanel(self.splitter_bottom_window)
            self.channelinfopanel.Show(False)
            self.libraryinfopanel = wx.Panel(self.splitter_bottom_window)#LibraryInfoPanel(self.splitter_bottom_window)
            self.libraryinfopanel.Show(False)
            self.playlistinfopanel = wx.Panel(self.splitter_bottom_window)#PlaylistInfoPanel(self.splitter_bottom_window)
