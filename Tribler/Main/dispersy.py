...
def main():
    ...
    if opt.script:
        from Tribler.Core.dispersy.script import Script, DispersyDestroyCommunityScript, DispersySyncScript, DispersySubjectiveSetScript, DispersySignatureScript, DispersyMemberTagScript
