...
class IPv8Endpoint(RESTEndpoint):
    ...
    def setup_routes(self):
        self.app.add_routes([web.get('/trustchain/users/{public_key}/blocks', self.get_blocks),
