...
class ChannelsEndpoint(BaseChannelsEndpoint):
    ...
    def render_GET(self, request):
        ...
        first, last, sort_by, sort_asc, query_filter, subscribed = ChannelsEndpoint.sanitize_parameters(args)
        ...
        return json.twisted_dumps(
            {"results": channels, "first": first, "last": last, "sort_by": sort_by.decode('utf-8'),
             "sort_desc": int(sort_asc), "total": total}
        )
