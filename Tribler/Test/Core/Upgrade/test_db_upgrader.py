...
from Tribler.Test.test_libtorrent_download import TORRENT_FILE_INFOHASH, TORRENT_FILE, TORRENT_VIDEO_FILE_INFOHASH
...
class TestDBUpgrader(AbstractServer):
    ...
    def setUp(self):
        super(TestDBUpgrader, self).setUp()
    ...
    def tearDown(self):
        super(TestDBUpgrader, self).tearDown()
        if self.sqlitedb:
            self.sqlitedb.close()
        self.sqlitedb = None
