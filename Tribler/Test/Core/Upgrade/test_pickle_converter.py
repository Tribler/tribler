...
class TestPickleConverter(TriblerCoreTest):
    ...
    def test_convert_session_config(self):
        old_pickle_dict = {"state_dir": "/", "mainline_dht_port": 1337, "torrent_checking": "maybe",
                           "torrent_collecting": "maybe", "libtorrent": False, "dispersy_port": 1337,
                           "minport": 1234}
        ...
        self.assertEqual(config.get_torrent_checking_enabled(), "maybe")
        self.assertEqual(config.get_torrent_collecting_enabled(), "maybe")
