...
class TestWatchFolder(TestAsServer):
    ...
    def test_watchfolder_no_files(self):
        self.session.download_manager.watch_folder.check_watch_folder()
    ...
    def test_cleanup(self):
        self.session.download_manager.watch_folder.cleanup_torrent_file(TESTS_DATA_DIR, 'thisdoesnotexist123.bla')
