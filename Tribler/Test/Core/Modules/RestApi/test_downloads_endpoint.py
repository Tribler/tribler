...
class TestDownloadsEndpoint(AbstractApiTest):
    ...
    @deferred(timeout=10)
    def test_get_peers_illegal_fields(self):
        """
        ...
        def verify_download_list(response):
            ...
            self.assertNotIn('extended_version', response_dict["downloads"][0]["peers"][0])
...
class TestDownloadsDispersyEndpoint(AbstractApiTest):
    ...
    def test_change_hops_fail(self):
        def on_remove_download(d, removecontent=False, removestate=True, hidden=False):
