...
from Tribler.Core.Modules.restapi.util import convert_search_torrent_to_json, convert_db_channel_to_json, \
    relevance_score_remote_torrent, get_parameter, fix_unicode_array, fix_unicode_dict
...
class TestRestApiUtil(TriblerCoreTest):
    ...
    def tearDown(self, annotate=True):
        # We are opening a session when assigning a relevance score to a remote torrent
        self.session = None
    ...
    def test_convert_torrent_to_json_dict(self):
        ...
        self.assertEqual(convert_search_torrent_to_json(input, None), output)
    ...
    def test_convert_torrent_to_json_tuple(self):
        ...
        self.assertEqual(convert_search_torrent_to_json(input_tuple, None), output)
    ...
    def test_rel_score_remote_torrent(self):
        self.assertNotEqual(relevance_score_remote_torrent("my-torrent.iso",
                                                           (struct.pack("I" * 12, *([1] * 12)), "torrent")), 0.0)
