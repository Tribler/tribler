...
from Tribler.Core.Utilities.utilities import create_valid_metainfo, valid_torrent_file, parse_magnetlink
...
class TriblerCoreTestUtilities(TriblerCoreTest):
    ...
    def test_valid_torrent_file_nodes_invalid_type(self):
        create_valid_metainfo({"info": {}, "nodes": {}})
    ...
    def test_valid_torrent_file_nodes_invalid_length(self):
        create_valid_metainfo({"info": {}, "nodes": [["a", "b", "c"]]})

    @raises(ValueError)
    def test_valid_torrent_file_nodes_invalid_host_type(self):
        create_valid_metainfo({"info": {}, "nodes": [[80, "127.0.0.1"]]})

    @raises(ValueError)
    def test_valid_torrent_file_nodes_invalid_port_type(self):
        create_valid_metainfo({"info": {}, "nodes": [["127.0.0.1", "8081"]]})
    ...
    def test_valid_torrent_file_initial_peers_wrong_type(self):
        create_valid_metainfo({"info": {}, "initial peers": {}})
    ...
    def test_valid_torrent_file_initial_peers_host_wrong_type(self):
        create_valid_metainfo({"info": {}, "initial peers": [(8081, "127.0.0.1")]})

    @raises(ValueError)
    def test_valid_torrent_file_initial_peers_port_wrong_type(self):
        create_valid_metainfo({"info": {}, "initial peers": [("127.0.0.1", "8081")]})
    ...
    def test_valid_torrent_file_info_name_wrong_type(self):
        create_valid_metainfo({"info": {"name": 42, "piece length": 12345, "pieces": "12345678901234567890"}})

    @raises(ValueError)
    def test_valid_torrent_file_info_piece_size_wrong_type(self):
        create_valid_metainfo({"info": {"name": "my_torrent", "piece length": "12345", "pieces": "12345678901234567890"}})

    @raises(ValueError)
    def test_valid_torrent_file_root_hash_wrong_length(self):
        create_valid_metainfo({"info": {"name": "my_torrent", "piece length": 12345, "root hash": "12345"}})
    ...
    def test_valid_torrent_root_hash(self):
        create_valid_metainfo({"info": {"name": "my_torrent", "piece length": 12345, "root hash": "12345678901234567890",
                                   "files": []}})
    ...
    def test_is_valid_torrent_file(self):
        self.assertTrue(valid_torrent_file({"info": {"name": "my_torrent", "piece length": 12345,
