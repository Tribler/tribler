...
class TestTunnelCommunity(AbstractTestTunnelCommunity):
    ...
    def test_circuit_request_cache(self):
        ...
        yield circuit_request_cache.on_timeout()
    ...
    def test_check_pong(self):
        ...
        msg1 = yield meta.impl(distribution=(self.tunnel_community.global_time,),
                         candidate=Candidate(("127.0.0.1", 1234), False), payload=(42, ping_num - 1))
        msg2 = yield meta.impl(distribution=(self.tunnel_community.global_time,),
    ...
    def test_check_destroy(self):
        ...
        msg1 = yield meta.impl(authentication=(self.member,), distribution=(self.tunnel_community.global_time,),
                         candidate=Candidate(sock_addr, False), payload=(42, 43))
        msg2 = yield meta.impl(authentication=(self.member,), distribution=(self.tunnel_community.global_time,),
    ...
    def test_send_to_destination_ip(self):
        ...
        yield exit_tunnel.sendto(data, ("127.0.0.1", 8080))
        yield exit_tunnel.close()
