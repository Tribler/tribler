...
class MyPreferenceList2(CommonTriblerList):
...
class FileList2(CommonTriblerList2):
    def __init__(self, parent):
        self.parent = parent
        ...
        CommonTriblerList2.__init__(self, parent, style, prefix, minid, maxid, 
...
class MyPreferencePanel(wx.Panel):
    def __init__(self, frame, parent):
        ...
        self.list=MyPreferenceList2(self)
...
class ABCFileFrame(wx.Frame):
    def __init__(self, parent):
        ...
        width = 800
        height = 500
        self.window_size = wx.Size(width+20, height+60)
        wx.Frame.__init__(self, None, -1, self.utility.lang.get('tb_file_short'), size=self.window_size)
        ...
        self.notebook_pages.append(self.filePanel)
        ...
        self.notebook_pages.append(self.myPreferencePanel)
        ...
        button = wx.Button(mainpanel, -1, self.utility.lang.get('configcolumns'), style = wx.BU_EXACTFIT)
        wx.EVT_BUTTON(self, button.GetId(), self.OnConfigColumns)
    ...
    def OnConfigColumns(self, event=None):
        curr_page = self.notebook.GetSelection()
        self.notebook_pages[curr_page].list.onColumnDialog()
