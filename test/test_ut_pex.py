...
class TestExtendHandshake(TestAsServer):
    ...
    def subtest_good_nontribler_extend_hs(self):
        ...
        self._test_good(self.create_good_nontribler_ut_pex,options=options,infohash=self.infohash)
    ...
    def create_good_tribler_extend_hs(self):
        d = {}
        d['m'] = {'Tr_OVERLAYSWARM':253,'ut_pex':1}
        d['p'] = self.mylistenport
        d['v'] = 'Tribler 3.5.1'
        d['e'] = 0
        bd = bencode(d)
