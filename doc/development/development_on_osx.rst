...
.. code-block:: none
    ...
    pip install --user cherrypy cffi chardet configobj cryptography decorator feedparser gmpy2 idna leveldb meliae netifaces numpy pillow pyasn1 pycparser twisted service_identity
