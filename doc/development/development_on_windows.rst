...
.. code-block:: none
    ...
    pip install cherrypy chardet configobj cryptography decorator dnspython ecdsa feedparser jsonrpclib keyring netifaces networkx pbkdf2 pillow protobuf pyaes pysocks requests twisted win_inet_pton keyring pbkdf2
