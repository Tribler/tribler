...
.. code-block:: none
    ...
    pip install bitcoinlib cherrypy chardet configobj configparser cryptography decorator feedparser meliae netifaces networkx pillow psutil twisted libnacl
