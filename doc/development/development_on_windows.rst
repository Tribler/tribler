...
.. code-block:: none
    ...
    pip install cherrypy chardet configobj cryptography decorator dnspython ecdsa feedparser jsonrpclib keyring keyrings.alt netifaces networkx pbkdf2 pillow protobuf pyaes pysocks requests twisted win_inet_pton
