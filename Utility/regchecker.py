...
class RegChecker:
	def __init__(self, utility):
		...
		abcpath = os.path.join(self.utility.abcpath, "abc.exe")
		iconpath = os.path.join(self.utility.abcpath, "torrenticon.ico")
	...
	def testRegistry(self):
		...
		try:
			...
			try:
				_compare_value_data = _value_data.lower()
				compare_value_data = value_data.lower()
			except:
				_compare_value_data = _value_data
				compare_value_data = value_data
	
			if _compare_value_data != compare_value_data:
	...
	def registerABC(self):
		...
		for _key_name, _value_name, _value_data, _value_type in self.reg_data:
			try:
	...
	def unregisterABC(self):
		...
		for _key_name in self.unreg_data:
			try:
