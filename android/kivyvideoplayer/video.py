...
class VideoCustom(Image):
    ...
    def __init__(self, download, **kwargs):
        self._video = None
        super(VideoCustom, self).__init__(**kwargs)
    ...
    def _do_video_load(self, *largs):
        ...
        if not self.source:
            ...
            self._video = VideoFFMpeg(self._download, filename=filename, **self.options)
...
if __name__ == '__main__':
    ...
    class VideoApp(App):
        def build(self):
            self.v = VideoCustom(source=sys.argv[1], state='play')
